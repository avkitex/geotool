...
CEL files and any renormalization (RMA etc.) are explicitly out of scope for
this phase -- see probe_mapping.py / clinical_annotate.py for what "cleaned"
and "mapped" mean here.
"""
...
from geotool import annotate, clinical_annotate, config, geo_fetch, probe_mapping
...
def download_cohort(
    gse_id: str, series_dir: Path | None = None, escalate_ambiguous: bool = False
) -> dict:
